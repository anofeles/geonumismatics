...
<div id="middle_area">
    ...
    <div id="usefull_links">
        <div class="usefull_subject">Useful Links</div>

        <ul>
            <li><a target="_blank" href="http://www.tsu.edu.ge/en/">
                    <img border="0" align="" src="{{asset('data/image_db_innova/banners/tsu_logo.png')}}" alt="" />
                    <span style="font-size:13px; font-family: Arial;">Ivane Javakhishvili Tbilisi State University</span></a></li>
            <li><a href="http://geohistory.humanities.tsu.ge/en/" target="_blank">
                    ...
                    <span style="font-size:13px; font-family: Arial;">Institute of Georgian History</span></a></li>
            <li><a target="_blank" href="http://www.rustaveli.org.ge/index.php?lang=eng">
                    ...
                    <span style="font-size:13px; font-family: Arial;">Shota Rustaveli National Science Foundation</span></a></li>
        </ul><br />

        <div class="note"><span>Project is funded by Shota Rustaveli National Science Foundation</span></div>
    </div>
</div>
@endsection
